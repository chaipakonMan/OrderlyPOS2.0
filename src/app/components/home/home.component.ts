...
export class HomeComponent {
  foods = [
    ...
    { name: 'Pad Ka Paow Over Rice Duck', selected: false, category: 'RiceDish', price: 15.99, quantity: 1, comment: "" },
    ...
    { name: 'Water Bottle', selected: false , category: 'Drink', price: 1.5, quantity: 1, comment: ""},
